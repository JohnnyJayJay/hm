...
Immer kleinere Zerlegungen eines Intervalls $[a,b]$

Eine Funktion $f$ ist /integrierbar über $[a,b]$/ gdw. $s_f = S_f$, d.h. die

#+DOWNLOADED: screenshot @ 2021-09-06 12:46:47
[[file:Integralrechnung/2021-09-06_12-46-47_screenshot.png]]
/Integrale bestimmen die "Fläche unter einer Funktion"./
...
Wieder schaut man sich Intervalle an, dieses mal mehrdimensionale Intervalle $I = [a_1, b_1] \times \dots \times [a_n, b_n]$ und betrachtet /Zerlegungen/ $Z$ dieser Intervalle, mit denen man die Ober- und Untersummen $S_f(Z)$ und $s_f(Z)$ berechnet. Wenn diese sich für beliebig feine Zerlegungen immer weiter annähern ($s_f = S_f$) ist die Funktion integrierbar ($\in R(I)$).
...
- $C(I) \subseteq R(I)$
*** Berechnen
Wenn Funktion $f$ unter dem Integral stetig:
