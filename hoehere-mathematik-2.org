...
2. $f(x)g(x) \to ab$
3. $|f(x)| \to |a|$
4. $\frac{1}{f(x)} \to \frac{1}{a}$ (sofern sinnvoll, sprich $a > 0$ und auf einem Bereich um $x_0$, auf dem $f$ nicht 0 ist)
...
Trick für 2 Eingangsdimensionen/komplexe Zahlen: Polarkoordinaten benutzen
