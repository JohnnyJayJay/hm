...
**** Stetige Funktionen
Der Grenzwert einer [[id:Stetigkeit][stetigen Funktion]] $f$ in $x_0$ muss gleich $f(x_0)$ sein, sofern definiert. Man kann in solchen Fällen einfach direkt $x_0$ einsetzen, um den Grenzwert zu berechnen.
...
Trick für 2 Eingangsdimensionen: Für den Fall $x_0 = (0, 0)$ kann man [[id:Polarkoordinaten][Polarkoordinaten]] statt (x, y) benutzen. Das kann es leichter machen, weil dadurch z.B. der Winkel wegfällt und man sich nur noch mit einer Variable ($r$) annähern muss, oder wenn man den Term dadurch so vereinfachen kann, dass er im Falle einer stetigen Funktion am Grenzpunkt definiert ist.
...
$f$ ist in 1 und 2 nicht stetig. Das kann man am einfachsten mit der [[id:Grenzwert-Definition][Grenzwert-Definition]] beweisen, wenn man weiß, dass $x^2$ stetig ist:
